...
extern "C" {
    ...
    fn clip(dr: *mut drawing, x: libc::c_int, y: libc::c_int, w: libc::c_int, h: libc::c_int);
...
static mut diffchars: [libc::c_char; 5] =
    unsafe { *::core::mem::transmute::<&[u8; 5], &[libc::c_char; 5]>(b"enth\0") };
static mut solver_fns: [Option<unsafe extern "C" fn(*mut solver_state) -> libc::c_int>; 4] = [
...
static mut grid_size_limits: [C2RustUnnamed_8; 18] = [
    {
        let mut init = C2RustUnnamed_8 {
            ...
            aerr: b"Width and height for this grid type must both be at least 3\0" as *const u8
    ...
    },
    {
        let mut init = C2RustUnnamed_8 {
            ...
            aerr: b"Width and height for this grid type must both be at least 1\0" as *const u8
                as *const libc::c_char,
    ...
    },
    {
        let mut init = C2RustUnnamed_8 {
            ...
            omin: 2 as libc::c_int,
            aerr: b"Width and height for this grid type must both be at least 2\0" as *const u8
                as *const libc::c_char,
            oerr: b"At least one of width and height for this grid type must be at least 2\0"
                as *const u8 as *const libc::c_char,
        };
    ...
    },
    {
        let mut init = C2RustUnnamed_8 {
            ...
            aerr: b"Width and height for this grid type must both be at least 6\0" as *const u8
                as *const libc::c_char,
...
unsafe extern "C" fn dup_game(mut state: *const game_state) -> *mut game_state {
    let mut ret: *mut game_state =
        smalloc(::core::mem::size_of::<game_state>() as libc::c_ulong) as *mut game_state;
...
unsafe extern "C" fn new_solver_state(
    ...
    let mut ret: *mut solver_state =
        smalloc(::core::mem::size_of::<solver_state>() as libc::c_ulong) as *mut solver_state;
    ...
    (*ret).dot_solved = smalloc(
        (num_dots as libc::c_ulong).wrapping_mul(::core::mem::size_of::<bool>() as libc::c_ulong),
    ) as *mut bool;
    (*ret).face_solved = smalloc(
        (num_faces as libc::c_ulong).wrapping_mul(::core::mem::size_of::<bool>() as libc::c_ulong),
    ) as *mut bool;
    memset(
...
unsafe extern "C" fn dup_solver_state(mut sstate: *const solver_state) -> *mut solver_state {
...
unsafe extern "C" fn default_params() -> *mut game_params {
    let mut ret: *mut game_params =
        smalloc(::core::mem::size_of::<game_params>() as libc::c_ulong) as *mut game_params;
...
unsafe extern "C" fn game_preset_menu() -> *mut preset_menu {
    ...
    {
        preset_menu_add_preset_with_title(top, &*loopy_presets_top.as_ptr().offset(i as isize));
        i += 1;
        i;
    }
    ...
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[game_params; 11]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<game_params>() as libc::c_ulong)
    {
        preset_menu_add_preset_with_title(more, &*loopy_presets_more.as_ptr().offset(i as isize));
        i += 1;
        i;
    }
    return top;
...
unsafe extern "C" fn decode_params(mut params: *mut game_params, mut string: *const libc::c_char) {
...
unsafe extern "C" fn game_configure(mut params: *const game_params) -> *mut config_item {
    ...
    *fresh4 = b"Grid type\0" as *const u8 as *const libc::c_char;
    ...
    let ref mut fresh5 = (*ret.offset(2 as libc::c_int as isize))
        .u
        .choices
        .choicenames;
    ...
    *fresh6 = b"Difficulty\0" as *const u8 as *const libc::c_char;
    ...
    let ref mut fresh7 = (*ret.offset(3 as libc::c_int as isize))
        .u
        .choices
        .choicenames;
...
unsafe extern "C" fn validate_params(
    ...
    if (*params).diff < DIFF_MAX as libc::c_int {
    } else {
        __assert_fail(
    ...
    while i < num_faces {
        if (*((*state).clues).offset(i as isize) as libc::c_int) < 0 as libc::c_int {
            ...
            dp = dp.offset(sprintf(
                ...
                if (*((*state).clues).offset(i as isize) as libc::c_int) < 0 as libc::c_int {
                    ' ' as i32
                } else if (*((*state).clues).offset(i as isize) as libc::c_int) < 10 as libc::c_int
                {
...
unsafe extern "C" fn extract_grid_desc(mut desc: *mut *const libc::c_char) -> *mut libc::c_char {
...
unsafe extern "C" fn validate_desc(
    ...
    while *desc != 0 {
            ...
            || *desc as libc::c_int >= 'A' as i32 && *desc as libc::c_int <= 'Z' as i32
        {
            ...
            grid_free(g);
            return b"Unknown character in description\0" as *const u8 as *const libc::c_char;
        }
        desc = desc.offset(1);
        desc;
    }
    if count < (*g).num_faces {
        grid_free(g);
        return b"Description too short for board size\0" as *const u8 as *const libc::c_char;
    }
    if count > (*g).num_faces {
        grid_free(g);
        return b"Description too long for board size\0" as *const u8 as *const libc::c_char;
    }
    grid_free(g);
    return 0 as *const libc::c_char;
}
...
unsafe extern "C" fn encode_solve_move(mut state: *const game_state) -> *mut libc::c_char {
    ...
    while i < num_edges {
        match *((*state).lines).offset(i as isize) as libc::c_int {
            0 => {
                p = p.offset(sprintf(p, b"%dy\0" as *const u8 as *const libc::c_char, i) as isize);
            }
            2 => {
                p = p.offset(sprintf(p, b"%dn\0" as *const u8 as *const libc::c_char, i) as isize);
            }
            _ => {}
        }
        i += 1;
...
unsafe extern "C" fn new_ui(mut state: *const game_state) -> *mut game_ui {
    let mut ui: *mut game_ui =
        smalloc(::core::mem::size_of::<game_ui>() as libc::c_ulong) as *mut game_ui;
...
unsafe extern "C" fn get_prefs(mut ui: *mut game_ui) -> *mut config_item {
    ...
    *fresh11 = b"Auto-follow unique paths of edges\0" as *const u8 as *const libc::c_char;
    ...
    *fresh12 = b"auto-follow\0" as *const u8 as *const libc::c_char;
    ...
    let ref mut fresh13 = (*ret.offset(1 as libc::c_int as isize))
        .u
        .choices
        .choicenames;
    ...
    *fresh14 = b":off:fixed:adaptive\0" as *const u8 as *const libc::c_char;
    (*ret.offset(1 as libc::c_int as isize)).u.choices.selected = (*ui).autofollow as libc::c_int;
...
unsafe extern "C" fn set_prefs(mut ui: *mut game_ui, mut cfg: *const config_item) {
    ...
    (*ui).autofollow =
        (*cfg.offset(1 as libc::c_int as isize)).u.choices.selected as C2RustUnnamed_5;
}
...
unsafe extern "C" fn game_compute_size(
    ...
    *x = rendered_width + 2 as libc::c_int * (tilesize / 2 as libc::c_int) + 1 as libc::c_int;
    *y = rendered_height + 2 as libc::c_int * (tilesize / 2 as libc::c_int) + 1 as libc::c_int;
}
...
unsafe extern "C" fn game_colours(
    ...
    *ret.offset((COL_FOREGROUND as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_FOREGROUND as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_FOREGROUND as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_LINEUNKNOWN as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) =
        *ret.offset((COL_BACKGROUND as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize)
            * 0.9f32;
    *ret.offset((COL_LINEUNKNOWN as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) =
        *ret.offset((COL_BACKGROUND as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize)
            * 0.9f32;
    *ret.offset((COL_LINEUNKNOWN as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_HIGHLIGHT as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) =
        1.0f32;
    *ret.offset((COL_HIGHLIGHT as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) =
        1.0f32;
    *ret.offset((COL_HIGHLIGHT as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) =
        1.0f32;
    *ret.offset((COL_MISTAKE as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) =
        1.0f32;
    *ret.offset((COL_MISTAKE as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_MISTAKE as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_SATISFIED as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_SATISFIED as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_SATISFIED as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) =
        0.0f32;
    *ret.offset((COL_FAINT as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize) = *ret
        .offset((COL_BACKGROUND as libc::c_int * 3 as libc::c_int + 0 as libc::c_int) as isize)
        * 0.9f32;
    *ret.offset((COL_FAINT as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize) = *ret
        .offset((COL_BACKGROUND as libc::c_int * 3 as libc::c_int + 1 as libc::c_int) as isize)
        * 0.9f32;
    *ret.offset((COL_FAINT as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize) = *ret
        .offset((COL_BACKGROUND as libc::c_int * 3 as libc::c_int + 2 as libc::c_int) as isize)
        * 0.9f32;
...
unsafe extern "C" fn game_new_drawstate(
    ...
    let mut ds: *mut game_drawstate =
        smalloc(::core::mem::size_of::<game_drawstate>() as libc::c_ulong) as *mut game_drawstate;
    let mut num_faces: libc::c_int = (*(*state).game_grid).num_faces;
    let mut num_edges: libc::c_int = (*(*state).game_grid).num_edges;
    let mut i: libc::c_int = 0;
    ...
    (*ds).clue_error = smalloc(
        (num_faces as libc::c_ulong).wrapping_mul(::core::mem::size_of::<bool>() as libc::c_ulong),
    ) as *mut bool;
    (*ds).clue_satisfied = smalloc(
        (num_faces as libc::c_ulong).wrapping_mul(::core::mem::size_of::<bool>() as libc::c_ulong),
    ) as *mut bool;
    (*ds).textx = smalloc(
        (num_faces as libc::c_ulong)
...
unsafe extern "C" fn game_free_drawstate(mut dr: *mut drawing, mut ds: *mut game_drawstate) {
...
unsafe extern "C" fn game_can_format_as_text_now(mut params: *const game_params) -> bool {
    if (*params).type_0 != 0 as libc::c_int {
        return 0 as libc::c_int != 0;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn game_text_format(mut state: *const game_state) -> *mut libc::c_char {
    ...
    if (*state).grid_type == 0 as libc::c_int {
    } else {
        __assert_fail(
    ...
    cell_size = abs((**((*f).dots).offset(0 as libc::c_int as isize)).x
    ...
    while y < H {
        ...
        *ret.offset((y * W + W - 1 as libc::c_int) as isize) = '\n' as i32 as libc::c_char;
        y += 1;
        y;
    }
    *ret.offset((H * W) as isize) = '\0' as i32 as libc::c_char;
    ...
    while i < (*g).num_edges {
        ...
        match *((*state).lines).offset(i as isize) as libc::c_int {
            ...
            1 => {}
            _ => {
                if (b"Illegal line state\0" as *const u8 as *const libc::c_char).is_null() {
                } else {
                    __assert_fail(
    ...
    while i < (*g).num_faces {
        ...
        x1_0 = ((**((*f).dots).offset(0 as libc::c_int as isize)).x - (*g).lowest_x) / cell_size;
        x2_0 = ((**((*f).dots).offset(2 as libc::c_int as isize)).x - (*g).lowest_x) / cell_size;
        y1_0 = ((**((*f).dots).offset(0 as libc::c_int as isize)).y - (*g).lowest_y) / cell_size;
        y2_0 = ((**((*f).dots).offset(2 as libc::c_int as isize)).y - (*g).lowest_y) / cell_size;
        x = x1_0 + x2_0;
        y = y1_0 + y2_0;
        *ret.offset((y * W + x) as isize) =
            (if (*((*state).clues).offset(i as isize) as libc::c_int) < 0 as libc::c_int {
                ...
                *((*state).clues).offset(i as isize) as libc::c_int - 10 as libc::c_int + 'A' as i32
            }) as libc::c_char;
        i += 1;
        i;
    }
...
unsafe extern "C" fn solver_set_line(
    ...
    *((*state).lines).offset(i as isize) = line_new as libc::c_char;
    ...
    if line_new as libc::c_uint == LINE_YES as libc::c_int as libc::c_uint {
        let ref mut fresh17 = *((*sstate).dot_yes_count).offset((*(*e).dot1).index as isize);
        *fresh17 += 1;
        *fresh17;
        let ref mut fresh18 = *((*sstate).dot_yes_count).offset((*(*e).dot2).index as isize);
        *fresh18 += 1;
        *fresh18;
        if !((*e).face1).is_null() {
            let ref mut fresh19 = *((*sstate).face_yes_count).offset((*(*e).face1).index as isize);
            *fresh19 += 1;
            *fresh19;
        }
        if !((*e).face2).is_null() {
            let ref mut fresh20 = *((*sstate).face_yes_count).offset((*(*e).face2).index as isize);
            *fresh20 += 1;
            *fresh20;
        }
    } else {
        let ref mut fresh21 = *((*sstate).dot_no_count).offset((*(*e).dot1).index as isize);
        *fresh21 += 1;
        *fresh21;
        let ref mut fresh22 = *((*sstate).dot_no_count).offset((*(*e).dot2).index as isize);
        *fresh22 += 1;
        *fresh22;
        if !((*e).face1).is_null() {
            let ref mut fresh23 = *((*sstate).face_no_count).offset((*(*e).face1).index as isize);
            *fresh23 += 1;
            *fresh23;
        }
        if !((*e).face2).is_null() {
            let ref mut fresh24 = *((*sstate).face_no_count).offset((*(*e).face2).index as isize);
            *fresh24 += 1;
            *fresh24;
        }
    }
...
unsafe extern "C" fn merge_dots(
    ...
    if i == j {
        ...
        len = *((*sstate).looplen).offset(i as isize) + *((*sstate).looplen).offset(j as isize);
...
unsafe extern "C" fn merge_lines(
    ...
    if i < (*(*(*sstate).state).game_grid).num_edges {
    } else {
        __assert_fail(
            b"i < sstate->state->game_grid->num_edges\0" as *const u8 as *const libc::c_char,
            b"/puzzles/loopy.c\0" as *const u8 as *const libc::c_char,
    ...
    if j < (*(*(*sstate).state).game_grid).num_edges {
    } else {
        __assert_fail(
            b"j < sstate->state->game_grid->num_edges\0" as *const u8 as *const libc::c_char,
            b"/puzzles/loopy.c\0" as *const u8 as *const libc::c_char,
    ...
    inverse = (inverse as u8 ^ inv_tmp as u8) != 0;
...
unsafe extern "C" fn dot_order(
    ...
    while i < (*d).order {
        ...
        if *((*state).lines).offset((*e).index as isize) as libc::c_int == line_type as libc::c_int
        {
            n += 1;
            n;
        }
...
unsafe extern "C" fn dot_setall(
    ...
    while i < (*d).order {
        ...
        if *((*state).lines).offset(line_index as isize) as libc::c_int == old_type as libc::c_int {
...
unsafe extern "C" fn add_full_clues(mut state: *mut game_state, mut rs: *mut random_state) {
    ...
    while i < (*g).num_edges {
        ...
        if c1 as libc::c_uint != FACE_GREY as libc::c_int as libc::c_uint {
        } else {
            __assert_fail(
        ...
        if c2 as libc::c_uint != FACE_GREY as libc::c_int as libc::c_uint {
        } else {
            __assert_fail(
...
unsafe extern "C" fn game_has_unique_soln(
    ...
    if (*sstate_new).solver_status as libc::c_uint != SOLVER_MISTAKE as libc::c_int as libc::c_uint
    {
    } else {
        __assert_fail(
            b"sstate_new->solver_status != SOLVER_MISTAKE\0" as *const u8 as *const libc::c_char,
            b"/puzzles/loopy.c\0" as *const u8 as *const libc::c_char,
    ...
    ret =
        (*sstate_new).solver_status as libc::c_uint == SOLVER_SOLVED as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn remove_clues(
    ...
    while n < num_faces {
        ...
        *((*ret).clues).offset(*face_list.offset(n as isize) as isize) =
...
unsafe extern "C" fn new_game_desc(
    ...
    loop {
        ...
        if !((*params).diff > 0 as libc::c_int
            && game_has_unique_soln(state, (*params).diff - 1 as libc::c_int) as libc::c_int != 0)
        {
            break;
        }
    }
    ...
    if (validate_desc(params, retval)).is_null() {
    } else {
        __assert_fail(
...
unsafe extern "C" fn new_game(
    ...
    (*state).line_errors = smalloc(
        (num_edges as libc::c_ulong).wrapping_mul(::core::mem::size_of::<bool>() as libc::c_ulong),
    ) as *mut bool;
    (*state).exactly_one_loop = 0 as libc::c_int != 0;
    (*state).cheated = 0 as libc::c_int != 0;
...
unsafe extern "C" fn check_completion(mut state: *mut game_state) -> bool {
    ...
    while i < (*g).num_dots {
        ...
        let mut yes: libc::c_int = dot_order(state, i, LINE_YES as libc::c_int as libc::c_char);
        let mut unknown: libc::c_int =
            dot_order(state, i, LINE_UNKNOWN as libc::c_int as libc::c_char);
        if yes == 1 as libc::c_int && unknown == 0 as libc::c_int || yes >= 3 as libc::c_int {
            let mut d: *mut grid_dot = *((*g).dots).offset(i as isize);
            let mut j: libc::c_int = 0;
            j = 0 as libc::c_int;
            while j < (*d).order {
                let mut e_0: libc::c_int = (**((*d).edges).offset(j as isize)).index;
                if *((*state).lines).offset(e_0 as isize) as libc::c_int == LINE_YES as libc::c_int
                {
        ...
        while i < (*g).num_edges {
            if *((*state).lines).offset(i as isize) as libc::c_int == LINE_YES as libc::c_int {
                ...
                if *component_state.offset(comp_0 as isize) == COMP_PATH as libc::c_int
                    ...
                    || *component_state.offset(comp_0 as isize) == COMP_LOOP as libc::c_int
                        && comp_0 != largest_comp
                {
    ...
    if nloop == 1 as libc::c_int && npath == 0 as libc::c_int && nsilly == 0 as libc::c_int {
...
unsafe extern "C" fn set_atleastone(
        ...
        != 0
    {
        ...
        *fresh28 =
            (*fresh28 as libc::c_int | (1 as libc::c_int) << 0 as libc::c_int) as libc::c_char;
        1 as libc::c_int
    } != 0;
}
...
unsafe extern "C" fn set_atmostone(
        ...
        != 0
    {
        ...
        *fresh30 =
            (*fresh30 as libc::c_int | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_char;
        1 as libc::c_int
    } != 0;
}
unsafe extern "C" fn array_setall(
    ...
    loop {
        ...
        *p = to;
        len_remaining =
            (len_remaining as libc::c_long - p.offset_from(p_old) as libc::c_long) as libc::c_int;
        p_old = p;
    }
}
unsafe extern "C" fn dline_set_opp_atleastone(
    ...
    while opp < N {
        ...
        if !(opp == edge || opp == edge + 1 as libc::c_int || opp == edge - 1 as libc::c_int) {
            if !(opp == 0 as libc::c_int && edge == N - 1 as libc::c_int) {
                if !(opp == N - 1 as libc::c_int && edge == 0 as libc::c_int) {
                    ...
                    {
                        if !(*((*state).lines)
                            .offset((**((*d).edges).offset(opp2 as isize)).index as isize)
                            as libc::c_int
                            != LINE_UNKNOWN as libc::c_int)
                        {
...
unsafe extern "C" fn face_setall_identical(
    ...
    while i < N {
            ...
            != LINE_UNKNOWN as libc::c_int)
        {
            j = i + 1 as libc::c_int;
            while j < N {
                let mut line2_index: libc::c_int = (**((*f).edges).offset(j as isize)).index;
...
unsafe extern "C" fn parity_deductions(
    ...
    if unknown_count == 2 as libc::c_int {
        ...
        can[0 as libc::c_int as usize] =
            dsf_canonify_flip(linedsf, e_0[0 as libc::c_int as usize], inv.as_mut_ptr());
        can[1 as libc::c_int as usize] = dsf_canonify_flip(
            linedsf,
            e_0[1 as libc::c_int as usize],
            inv.as_mut_ptr().offset(1 as libc::c_int as isize),
        );
        can[2 as libc::c_int as usize] = dsf_canonify_flip(
            linedsf,
        ...
        if can[0 as libc::c_int as usize] == can[1 as libc::c_int as usize] {
            if solver_set_line(
                ...
                e_0[2 as libc::c_int as usize],
                (if total_parity
                    ^ inv[0 as libc::c_int as usize] as libc::c_int
                    ^ inv[1 as libc::c_int as usize] as libc::c_int
                    != 0
                {
        ...
        if can[0 as libc::c_int as usize] == can[2 as libc::c_int as usize] {
            if solver_set_line(
                ...
                (if total_parity
                    ^ inv[0 as libc::c_int as usize] as libc::c_int
                    ^ inv[2 as libc::c_int as usize] as libc::c_int
                    != 0
                {
                    LINE_YES as libc::c_int
                } else {
        ...
        can_0[0 as libc::c_int as usize] =
            dsf_canonify_flip(linedsf, e_1[0 as libc::c_int as usize], inv_0.as_mut_ptr());
        can_0[1 as libc::c_int as usize] = dsf_canonify_flip(
            linedsf,
            e_1[1 as libc::c_int as usize],
            inv_0.as_mut_ptr().offset(1 as libc::c_int as isize),
        );
        can_0[2 as libc::c_int as usize] = dsf_canonify_flip(
            linedsf,
            e_1[2 as libc::c_int as usize],
            inv_0.as_mut_ptr().offset(2 as libc::c_int as isize),
        );
        can_0[3 as libc::c_int as usize] = dsf_canonify_flip(
            linedsf,
        ...
        if can_0[0 as libc::c_int as usize] == can_0[1 as libc::c_int as usize] {
            if merge_lines(
                ...
                e_1[3 as libc::c_int as usize],
                total_parity
                    ^ inv_0[0 as libc::c_int as usize] as libc::c_int
                    ^ inv_0[1 as libc::c_int as usize] as libc::c_int
                    != 0,
            ) {
                diff = if diff < DIFF_HARD as libc::c_int {
                    diff
            ...
            if merge_lines(
                ...
                total_parity
                    ^ inv_0[0 as libc::c_int as usize] as libc::c_int
                    ^ inv_0[2 as libc::c_int as usize] as libc::c_int
                    != 0,
            ) {
                diff = if diff < DIFF_HARD as libc::c_int {
                    diff
            ...
            if merge_lines(
                ...
                total_parity
                    ^ inv_0[0 as libc::c_int as usize] as libc::c_int
                    ^ inv_0[3 as libc::c_int as usize] as libc::c_int
                    != 0,
            ) {
                diff = if diff < DIFF_HARD as libc::c_int {
                    diff
...
unsafe extern "C" fn trivial_deductions(mut sstate: *mut solver_state) -> libc::c_int {
    ...
    while i < (*g).num_faces {
        ...
        if !*((*sstate).face_solved).offset(i as isize) {
            ...
            } else if !((*((*state).clues).offset(i as isize) as libc::c_int) < 0 as libc::c_int) {
                ...
                if *((*state).clues).offset(i as isize) as libc::c_int == current_yes {
                    ...
                    *((*sstate).face_solved).offset(i as isize) = 1 as libc::c_int != 0;
                        ...
                        == current_no
                    {
                        ...
                        *((*sstate).face_solved).offset(i as isize) = 1 as libc::c_int != 0;
                    } else if (*f).order - *((*state).clues).offset(i as isize) as libc::c_int
                        ...
                        's_114: loop {
                                    ...
                                    == LINE_UNKNOWN as libc::c_int
                            {
                                ...
                                while k < (**((*g).dots).offset(d as isize)).order {
                                    let mut e_0: libc::c_int =
                                        (**((**((*g).dots).offset(d as isize)).edges)
                                            .offset(k as isize))
                                        .index;
                                ...
                                while j < (*f).order {
                                        ...
                                        && e != e2
                                    {
                                        ...
                                        if r {
                                            ...
                                            __assert_fail(
                                                b"r\0" as *const u8 as *const libc::c_char,
                                                b"/puzzles/loopy.c\0" as *const u8
                                                    as *const libc::c_char,
    ...
    while i < (*g).num_faces {
        ...
        if !*((*sstate).face_solved).offset(i as isize) {
            if !(clue < 0 as libc::c_int) {
                j = 0 as libc::c_int;
                while j < N {
                    let mut edge_index: libc::c_int = (**((*f).edges).offset(j as isize)).index;
                    let mut dline_index: libc::c_int = 0;
                    let mut line1: line_state =
                        *((*state).lines).offset(edge_index as isize) as line_state;
                ...
                while m < N {
                    ...
                    while j < N {
                        ...
                        maxs[j as usize][k_0 as usize] =
                            maxs[j as usize][u as usize] + maxs[u as usize][k_0 as usize];
                        mins[j as usize][k_0 as usize] =
                            mins[j as usize][u as usize] + mins[u as usize][k_0 as usize];
                        tmp_0 = maxs[j as usize][v as usize] + maxs[v as usize][k_0 as usize];
                        maxs[j as usize][k_0 as usize] = if maxs[j as usize][k_0 as usize] < tmp_0 {
                            maxs[j as usize][k_0 as usize]
                        } else {
                            tmp_0
                        };
                        tmp_0 = mins[j as usize][v as usize] + mins[v as usize][k_0 as usize];
                        mins[j as usize][k_0 as usize] = if mins[j as usize][k_0 as usize] > tmp_0 {
                            mins[j as usize][k_0 as usize]
                        } else {
                            tmp_0
                        };
        ...
        if !*((*sstate).dot_solved).offset(i as isize) {
            ...
            while j_0 < N_0 {
                ...
                if is_atmostone(dlines, dline_index_1) {
                    if line1_0 as libc::c_uint == LINE_YES as libc::c_int as libc::c_uint
                        && line2_0 as libc::c_uint == LINE_UNKNOWN as libc::c_int as libc::c_uint
                    {
                    ...
                    if line2_0 as libc::c_uint == LINE_YES as libc::c_int as libc::c_uint
                        && line1_0 as libc::c_uint == LINE_UNKNOWN as libc::c_int as libc::c_uint
                    {
                ...
                if !(line1_0 as libc::c_uint != LINE_UNKNOWN as libc::c_int as libc::c_uint
                    || line2_0 as libc::c_uint != LINE_UNKNOWN as libc::c_int as libc::c_uint)
                {
                        ...
                        if is_atleastone(dlines, dline_index_1) {
                            ...
                            while opp < N_0 {
                                ...
                                if !(opp == j_0
                                    ...
                                    || opp == j_0 - 1 as libc::c_int)
                                {
                                    if !(j_0 == 0 as libc::c_int && opp == N_0 - 1 as libc::c_int) {
...
unsafe extern "C" fn linedsf_deductions(mut sstate: *mut solver_state) -> libc::c_int {
    ...
    while i < (*g).num_dots {
                ...
                != LINE_UNKNOWN as libc::c_int)
            {
                    ...
                    != LINE_UNKNOWN as libc::c_int)
                {
                    ...
                    if can1 == can2 && inv1 as libc::c_int != inv2 as libc::c_int {
                        ...
                        && is_atleastone(dlines, dline_index) as libc::c_int != 0
                    {
                        if merge_lines(sstate, line1_index, line2_index, 1 as libc::c_int != 0) {
                            diff = if diff < DIFF_HARD as libc::c_int {
                                diff
                            } else {
                                DIFF_HARD as libc::c_int
        ...
        diff_tmp = parity_deductions(sstate, (*d).edges, yes_0 % 2 as libc::c_int, unknown_0);
        diff = if diff < diff_tmp { diff } else { diff_tmp };
        i += 1;
        i;
    }
            ...
            if s as libc::c_uint != LINE_UNKNOWN as libc::c_int as libc::c_uint {
                if solver_set_line(
                    ...
                    (if inv as libc::c_int != 0 {
                        (2 as libc::c_int as libc::c_uint).wrapping_sub(s as libc::c_uint)
                    } else {
                        s as libc::c_uint
                    }) as line_state,
                ) {
...
unsafe extern "C" fn loop_deductions(mut sstate: *mut solver_state) -> libc::c_int {
    ...
    while i < (*g).num_faces {
        let mut c: libc::c_int = *((*state).clues).offset(i as isize) as libc::c_int;
        if c >= 0 as libc::c_int {
            let mut o: libc::c_int = *((*sstate).face_yes_count).offset(i as isize) as libc::c_int;
            if o == c {
                satclues += 1;
                satclues;
    ...
    i = 0 as libc::c_int;
    while i < (*g).num_dots {
        dots_connected = *((*sstate).looplen).offset(dsf_canonify((*sstate).dotdsf, i) as isize);
    ...
    if (*sstate).solver_status as libc::c_uint == SOLVER_INCOMPLETE as libc::c_int as libc::c_uint {
    } else {
        __assert_fail(
            b"sstate->solver_status == SOLVER_INCOMPLETE\0" as *const u8 as *const libc::c_char,
            b"/puzzles/loopy.c\0" as *const u8 as *const libc::c_char,
    ...
    if satclues == clues && shortest_chainlen == edgecount {
        ...
        while i < (*g).num_edges {
            ...
            if !(*((*state).lines).offset(i as isize) as libc::c_int != LINE_UNKNOWN as libc::c_int)
            {
                eqclass = dsf_canonify((*sstate).dotdsf, d1);
                if !(eqclass != dsf_canonify((*sstate).dotdsf, d2)) {
                    val = LINE_NO as libc::c_int;
                    if *((*sstate).looplen).offset(eqclass as isize) == edgecount + 1 as libc::c_int
                    {
                        ...
                        if !((*e).face1).is_null() {
                            ...
                            let mut c_0: libc::c_int =
                                *((*state).clues).offset(f as isize) as libc::c_int;
                            if c_0 >= 0 as libc::c_int
                                && *((*sstate).face_yes_count).offset(f as isize) as libc::c_int
                                    == c_0 - 1 as libc::c_int
                            {
                                sm1_nearby += 1;
                                sm1_nearby;
                        ...
                        if !((*e).face2).is_null() {
                            ...
                            let mut c_1: libc::c_int =
                                *((*state).clues).offset(f_0 as isize) as libc::c_int;
                            if c_1 >= 0 as libc::c_int
                                && *((*sstate).face_yes_count).offset(f_0 as isize) as libc::c_int
                                    == c_1 - 1 as libc::c_int
                            {
                                sm1_nearby += 1;
                                sm1_nearby;
...
unsafe extern "C" fn solve_game_rec(mut sstate_start: *const solver_state) -> *mut solver_state {
    ...
    while i < solver_diffs.len() as i32 {
        ...
        {
            let mut next_diff: libc::c_int =
                (solver_fns[i as usize]).expect("non-null function pointer")(sstate);
...
unsafe extern "C" fn solve_game(
    ...
    if (*new_sstate).solver_status as libc::c_uint == SOLVER_SOLVED as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn interpret_move(
    ...
    match button {
        512 => match old_state as libc::c_uint {
            1 => {
        ...
        514 => match old_state as libc::c_uint {
            1 => {
    ...
    if (*ui).autofollow as libc::c_uint != AF_OFF as libc::c_int as libc::c_uint {
        ...
        while dotid < 2 as libc::c_int {
            ...
            loop {
                ...
                j = n_found;
                while j < (*dot).order {
                    let mut e_candidate: *mut grid_edge = *((*dot).edges).offset(j as isize);
                    ...
                    if e_candidate != e_this
                        && ((*ui).autofollow as libc::c_uint
                            ...
                            || *((*state).lines).offset(i as isize) as libc::c_int
                                == LINE_NO as libc::c_int
                            || *((*state).lines).offset(i_candidate as isize) as libc::c_int
                                != LINE_NO as libc::c_int)
                    {
                        e_next = e_candidate;
                        n_found += 1;
                ...
                if movelen > movesize - 40 as libc::c_int {
                    movesize = movesize * 5 as libc::c_int / 4 as libc::c_int + 128 as libc::c_int;
                    movebuf = srealloc(
...
unsafe extern "C" fn execute_move(
    ...
    loop {
        ...
        move_0 = move_0
            .offset(strspn(move_0, b"1234567890\0" as *const u8 as *const libc::c_char) as isize);
        let fresh31 = move_0;
        move_0 = move_0.offset(1);
        match *fresh31 as libc::c_int {
            121 => {
                *((*newstate).lines).offset(i as isize) = LINE_YES as libc::c_int as libc::c_char;
            }
            110 => {
                *((*newstate).lines).offset(i as isize) = LINE_NO as libc::c_int as libc::c_char;
            }
            117 => {
                *((*newstate).lines).offset(i as isize) =
                    LINE_UNKNOWN as libc::c_int as libc::c_char;
            }
            _ => {
                current_block = 3870127747039110117;
...
unsafe extern "C" fn edge_bbox(
    ...
    xmin =
        (if x1 < x2 { x1 } else { x2 }) - ((*ds).tilesize + 15 as libc::c_int) / 16 as libc::c_int;
    xmax =
        (if x1 > x2 { x1 } else { x2 }) + ((*ds).tilesize + 15 as libc::c_int) / 16 as libc::c_int;
    ymin =
        (if y1 < y2 { y1 } else { y2 }) - ((*ds).tilesize + 15 as libc::c_int) / 16 as libc::c_int;
    ymax =
        (if y1 > y2 { y1 } else { y2 }) + ((*ds).tilesize + 15 as libc::c_int) / 16 as libc::c_int;
    *x = xmin;
    *y = ymin;
...
unsafe extern "C" fn dot_bbox(
    ...
    xmin = x1 - ((*ds).tilesize * 5 as libc::c_int + 63 as libc::c_int) / 64 as libc::c_int;
    xmax = x1 + ((*ds).tilesize * 5 as libc::c_int + 63 as libc::c_int) / 64 as libc::c_int;
    ymin = y1 - ((*ds).tilesize * 5 as libc::c_int + 63 as libc::c_int) / 64 as libc::c_int;
    ymax = y1 + ((*ds).tilesize * 5 as libc::c_int + 63 as libc::c_int) / 64 as libc::c_int;
    *x = xmin;
    *y = ymin;
    *w = xmax - xmin + 1 as libc::c_int;
    *h = ymax - ymin + 1 as libc::c_int;
...
unsafe extern "C" fn game_redraw_line(
    ...
    } else if *((*state).lines).offset(i as isize) as libc::c_int == LINE_UNKNOWN as libc::c_int {
        line_colour = COL_LINEUNKNOWN as libc::c_int;
    } else if *((*state).lines).offset(i as isize) as libc::c_int == LINE_NO as libc::c_int {
    ...
    if line_colour == COL_FAINT as libc::c_int {
        ...
        draw_thick_line(
            dr,
            (((*ds).tilesize * 3 as libc::c_int) as libc::c_double / 32.0f64) as libc::c_float,
            (x1 as libc::c_double + 0.5f64) as libc::c_float,
            (y1 as libc::c_double + 0.5f64) as libc::c_float,
            (x2 as libc::c_double + 0.5f64) as libc::c_float,
            (y2 as libc::c_double + 0.5f64) as libc::c_float,
...
unsafe extern "C" fn game_redraw(
    ...
    while i < (*g).num_faces {
        ...
        if !(n < 0 as libc::c_int) {
            ...
            if clue_mistake as libc::c_int != *((*ds).clue_error).offset(i as isize) as libc::c_int
    ...
    if flashtime > 0 as libc::c_int as libc::c_float
        && (flashtime <= 0.5f32 / 3 as libc::c_int as libc::c_float
            || flashtime
                >= 0.5f32 * 2 as libc::c_int as libc::c_float / 3 as libc::c_int as libc::c_float)
    {
    ...
    i = 0 as libc::c_int;
    while i < (*g).num_edges {
        let mut new_ds: libc::c_char =
            (if *((*state).line_errors).offset(i as isize) as libc::c_int != 0 {
        ...
        if new_ds as libc::c_int != *((*ds).lines).offset(i as isize) as libc::c_int
            || flash_changed as libc::c_int != 0
                && *((*state).lines).offset(i as isize) as libc::c_int == LINE_YES as libc::c_int
        {
    ...
    if redraw_everything {
        ...
        i = 0 as libc::c_int;
        while i < nfaces {
            let mut f_0: *mut grid_face = *((*g).faces).offset(faces[i as usize] as isize);
            let mut x: libc::c_int = 0;
            let mut y: libc::c_int = 0;
...
unsafe extern "C" fn game_flash_length(
    ...
    if !(*oldstate).solved
        && (*newstate).solved as libc::c_int != 0
        && !(*oldstate).cheated
        && !(*newstate).cheated
    {
        return 0.5f32;
...
pub static mut thegame: game = unsafe {
    {
        let mut init = game {
            ...
            default_params: Some(default_params as unsafe extern "C" fn() -> *mut game_params),
            fetch_preset: None,
            preset_menu: Some(game_preset_menu as unsafe extern "C" fn() -> *mut preset_menu),
            decode_params: Some(
                decode_params as unsafe extern "C" fn(*mut game_params, *const libc::c_char) -> (),
            ),
            encode_params: Some(
                encode_params
                    as unsafe extern "C" fn(*const game_params, bool) -> *mut libc::c_char,
            ),
            free_params: Some(free_params as unsafe extern "C" fn(*mut game_params) -> ()),
            dup_params: Some(
                dup_params as unsafe extern "C" fn(*const game_params) -> *mut game_params,
            ),
            can_configure: 1 as libc::c_int != 0,
            configure: Some(
                game_configure as unsafe extern "C" fn(*const game_params) -> *mut config_item,
            ),
            custom_params: Some(
                custom_params as unsafe extern "C" fn(*const config_item) -> *mut game_params,
            ),
            validate_params: Some(
                validate_params
                    as unsafe extern "C" fn(*const game_params, bool) -> *const libc::c_char,
            ),
            new_desc: Some(
                new_game_desc
            ...
            dup_game: Some(dup_game as unsafe extern "C" fn(*const game_state) -> *mut game_state),
            ...
            can_format_as_text_now: Some(
                game_can_format_as_text_now as unsafe extern "C" fn(*const game_params) -> bool,
            ),
            text_format: Some(
                game_text_format as unsafe extern "C" fn(*const game_state) -> *mut libc::c_char,
            ),
            get_prefs: Some(get_prefs as unsafe extern "C" fn(*mut game_ui) -> *mut config_item),
            set_prefs: Some(
                set_prefs as unsafe extern "C" fn(*mut game_ui, *const config_item) -> (),
            ),
            new_ui: Some(new_ui as unsafe extern "C" fn(*const game_state) -> *mut game_ui),
            ...
            colours: Some(
                game_colours
                    as unsafe extern "C" fn(*mut frontend, *mut libc::c_int) -> *mut libc::c_float,
            ),
            new_drawstate: Some(
                game_new_drawstate
                    as unsafe extern "C" fn(*mut drawing, *const game_state) -> *mut game_drawstate,
            ),
            free_drawstate: Some(
                game_free_drawstate
            ...
            status: Some(game_status as unsafe extern "C" fn(*const game_state) -> libc::c_int),
    ...
    loop {
        ...
        if strcmp(p_0, b"--seed\0" as *const u8 as *const libc::c_char) == 0 {
            if argc < 2 as libc::c_int {
                usage_exit(b"--seed needs an argument\0" as *const u8 as *const libc::c_char);
            }
            argv = argv.offset(1);
            ...
            if argc < 2 as libc::c_int {
                usage_exit(b"--count needs an argument\0" as *const u8 as *const libc::c_char);
            }
            argv = argv.offset(1);
