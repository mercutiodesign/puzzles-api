...
unsafe extern "C" fn point_mul_by_t(mut x: Point) -> Point {
    ...
    r
        .coeffs[1 as libc::c_int
        as usize] = x.coeffs[0 as libc::c_int as usize]
    ...
    r
        ...
        - x.coeffs[3 as libc::c_int as usize];
    r
        .coeffs[3 as libc::c_int
        as usize] = x.coeffs[2 as libc::c_int as usize]
        + x.coeffs[3 as libc::c_int as usize];
    return r;
}
#[inline]
...
unsafe extern "C" fn point_x(mut p: Point) -> Coord {
    let mut x: Coord = {
        let mut init = Coord {
            ...
            cr5: p.coeffs[1 as libc::c_int as usize]
                + p.coeffs[2 as libc::c_int as usize]
                - p.coeffs[3 as libc::c_int as usize],
        };
        init
    ...
    let mut y: Coord = {
        let mut init = Coord {
            c1: 2 as libc::c_int * p.coeffs[1 as libc::c_int as usize]
                + p.coeffs[2 as libc::c_int as usize]
                + p.coeffs[3 as libc::c_int as usize],
            cr5: p.coeffs[2 as libc::c_int as usize]
                + p.coeffs[3 as libc::c_int as usize],
        };
        init
    };
...
#[no_mangle]
pub unsafe extern "C" fn penrose_valid_letter(
    mut c: libc::c_char,
...
pub unsafe extern "C" fn penrose_coords_new() -> *mut PenroseCoords {
    let mut pc: *mut PenroseCoords = smalloc(
        ::core::mem::size_of::<PenroseCoords>() as libc::c_ulong,
    ) as *mut PenroseCoords;
...
#[no_mangle]
pub unsafe extern "C" fn penrose_coords_make_space(
    mut pc: *mut PenroseCoords,
    mut size: size_t,
) {
    if (*pc).csize < size {
        (*pc)
            .csize = ((*pc).csize * 5 as libc::c_int as size_t
...
#[no_mangle]
pub unsafe extern "C" fn penrose_coords_copy(
    mut pc_in: *mut PenroseCoords,
) -> *mut PenroseCoords {
...
unsafe extern "C" fn penrosectx_step_recurse(
    ...
    if tr.type_0 as libc::c_uint == INTERNAL as libc::c_int as libc::c_uint {} else {
        __assert_fail(
...
pub unsafe extern "C" fn penrose_place(
    ...
    while i < 3 as libc::c_int as libc::c_uint {
        ...
        delta = point_mul(
            delta,
            penrose_triangle_post_edge(
                *((*(*tri).pc).c).offset(0 as libc::c_int as isize),
                edge,
            ),
        );
        i = i.wrapping_add(1);
...
unsafe extern "C" fn penrose_choose_random(
    ...
    'c_7362: {
        if 0 as libc::c_int != 0
            && !(b"Probability overflow!\0" as *const u8 as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
                b"false && \"Probability overflow!\"\0" as *const u8
...
unsafe extern "C" fn penrose_starting_tiles(
    mut which: libc::c_int,
) -> *const libc::c_char {
...
unsafe extern "C" fn penrose_valid_parents(
    mut tile: libc::c_char,
) -> *const libc::c_char {
...
pub unsafe extern "C" fn penrosectx_init_random(
    ...
    *((*(*ctx).prototype).c)
    ...
    (*ctx)
        .start_vertex = random_upto(rs, 3 as libc::c_int as libc::c_ulong)
        as libc::c_uint;
    (*ctx)
        .orientation = random_upto(rs, 10 as libc::c_int as libc::c_ulong)
        as libc::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn penrosectx_extend_coords(
    ...
    while (*pc).nc < n {
        *((*pc).c)
            .offset(
                (*pc).nc as isize,
            ) = *((*(*ctx).prototype).c).offset((*pc).nc as isize);
...
#[no_mangle]
pub unsafe extern "C" fn penrose_initial(
    mut ctx: *mut PenroseContext,
) -> *mut PenroseTriangle {
    let mut type_0: libc::c_char = *((*(*ctx).prototype).c)
    ...
    let mut i: size_t = 0;
    let mut tri: *mut PenroseTriangle = smalloc(
        ::core::mem::size_of::<PenroseTriangle>() as libc::c_ulong,
    ) as *mut PenroseTriangle;
...
pub unsafe extern "C" fn penrose_adjacent(
    ...
    let mut dst_tri: *mut PenroseTriangle = smalloc(
        ::core::mem::size_of::<PenroseTriangle>() as libc::c_ulong,
    ) as *mut PenroseTriangle;
...
pub unsafe extern "C" fn penrosectx_generate(
    mut ctx: *mut PenroseContext,
    mut inbounds_0: Option::<
        unsafe extern "C" fn(*mut libc::c_void, *const PenroseTriangle) -> bool,
    >,
    ...
    while !qhead.is_null() {
        ...
        let mut sibling_edge: libc::c_uint = penrose_sibling_edge_index(
            *((*(*tri_0).pc).c).offset(0 as libc::c_int as isize),
        );
        ...
        while edge < 3 as libc::c_int as libc::c_uint {
            ...
            if !inbounds_0.expect("non-null function pointer")(inboundsctx, new_tri) {
                ...
                found_tri = find234(placed, new_tri as *mut libc::c_void, None)
                    as *mut PenroseTriangle;
                if !found_tri.is_null() {
                    if edge == sibling_edge && !(*tri_0).reported
                        && !(*found_tri).reported
                    {
                        ...
                        tile
                            ...
                            )(tilectx, tilevertices.as_mut_ptr());
...
unsafe extern "C" fn null_output_tile(
    mut vctx: *mut libc::c_void,
    mut vertices: *const Point,
) {}
unsafe extern "C" fn really_output_tile(
    mut vctx: *mut libc::c_void,
    mut vertices: *const Point,
) {
    let mut octx: *mut PenroseOutputCtx = vctx as *mut PenroseOutputCtx;
    ...
    while i < 4 as libc::c_int as size_t {
        ...
        coords[(4 as libc::c_int as size_t * i).wrapping_add(0 as libc::c_int as size_t)
            as usize] = x.c1 + (*octx).xoff;
        coords[(4 as libc::c_int as size_t * i).wrapping_add(1 as libc::c_int as size_t)
            as usize] = x.cr5;
        coords[(4 as libc::c_int as size_t * i).wrapping_add(2 as libc::c_int as size_t)
            as usize] = y.c1 + (*octx).yoff;
        coords[(4 as libc::c_int as size_t * i).wrapping_add(3 as libc::c_int as size_t)
            as usize] = y.cr5;
        i = i.wrapping_add(1);
        i;
    }
    ((*octx).external_cb)
        .expect(
            "non-null function pointer",
        )((*octx).external_cbctx, coords.as_mut_ptr());
}
...
pub unsafe extern "C" fn penrose_tiling_randomise(
    ...
    penrosectx_generate(
        ...
        Some(
            null_output_tile
                as unsafe extern "C" fn(*mut libc::c_void, *const Point) -> (),
        ),
