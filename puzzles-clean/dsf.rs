...
pub unsafe extern "C" fn dsf_copy(mut to: *mut DSF, mut from: *mut DSF) {
    ...
    if !((*to).flip).is_null() {
        if !((*from).flip).is_null()
            && !(b"Copying a non-flip dsf to a flip one\0" as *const u8
                as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
        ...
        'c_3282: {
            ...
            {} else {
                __assert_fail(
                    b"from->flip && \"Copying a non-flip dsf to a flip one\"\0"
    ...
    if !((*to).min).is_null() {
        if !((*from).min).is_null()
            && !(b"Copying a non-min dsf to a min one\0" as *const u8
                as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
...
unsafe extern "C" fn dsf_find_root(mut dsf: *mut DSF, mut n: size_t) -> size_t {
    while *((*dsf).parent_or_size).offset(n as isize)
        & ((2147483647 as libc::c_int as libc::c_uint)
            ...
            & !((2147483647 as libc::c_int as libc::c_uint)
                .wrapping_mul(2 as libc::c_uint)
                .wrapping_add(1 as libc::c_uint) >> 1 as libc::c_int)) == 0
    {
...
#[inline]
unsafe extern "C" fn dsf_path_compress(
    mut dsf: *mut DSF,
    mut n: size_t,
    mut root: size_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn dsf_canonify(
    mut dsf: *mut DSF,
    mut n: libc::c_int,
) -> libc::c_int {
    let mut root: size_t = 0;
    if 0 as libc::c_int <= n && (n as size_t) < (*dsf).size
    ...
    'c_3603: {
        if 0 as libc::c_int <= n && (n as size_t) < (*dsf).size
            && !(b"Overrun in dsf_canonify\0" as *const u8 as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
                b"0 <= n && n < dsf->size && \"Overrun in dsf_canonify\"\0" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn dsf_merge(
    mut dsf: *mut DSF,
    mut n1: libc::c_int,
    mut n2: libc::c_int,
) {
    ...
    let mut s2: size_t = 0;
    let mut root: size_t = 0;
    if 0 as libc::c_int <= n1 && (n1 as size_t) < (*dsf).size
    ...
    if 0 as libc::c_int <= n2 && (n2 as size_t) < (*dsf).size
        && !(b"Overrun in dsf_merge\0" as *const u8 as *const libc::c_char).is_null()
    {} else {
        __assert_fail(
    ...
    {} else {
        __assert_fail(
            b"!dsf->flip && \"dsf_merge on a flip dsf\"\0" as *const u8
                as *const libc::c_char,
            b"/puzzles/dsf.c\0" as *const u8 as *const libc::c_char,
    ...
    'c_3961: {
        if ((*dsf).flip).is_null()
            && !(b"dsf_merge on a flip dsf\0" as *const u8 as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
                b"!dsf->flip && \"dsf_merge on a flip dsf\"\0" as *const u8
    ...
    if r1 == r2 {
        ...
        s1 = (*((*dsf).parent_or_size).offset(r1 as isize)
            & (2147483647 as libc::c_int as libc::c_uint)
                .wrapping_mul(2 as libc::c_uint)
                .wrapping_add(1 as libc::c_uint) >> 1 as libc::c_int) as size_t;
...
pub unsafe extern "C" fn dsf_size(mut dsf: *mut DSF, mut n: libc::c_int) -> libc::c_int {
    ...
    return (*((*dsf).parent_or_size).offset(root as isize)
        & (2147483647 as libc::c_int as libc::c_uint)
            .wrapping_mul(2 as libc::c_uint)
            .wrapping_add(1 as libc::c_uint) >> 1 as libc::c_int) as libc::c_int;
}
#[inline]
...
pub unsafe extern "C" fn dsf_canonify_flip(
    ...
    if 0 as libc::c_int <= n && (n as size_t) < (*dsf).size
        && !(b"Overrun in dsf_canonify_flip\0" as *const u8 as *const libc::c_char)
            .is_null()
    {} else {
        __assert_fail(
    ...
    'c_5078: {
        ...
        {} else {
            __assert_fail(
                b"0 <= n && n < dsf->size && \"Overrun in dsf_canonify_flip\"\0"
                    as *const u8 as *const libc::c_char,
                b"/puzzles/dsf.c\0" as *const u8 as *const libc::c_char,
                241 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
    ...
    if !((*dsf).flip).is_null()
        && !(b"dsf_canonify_flip on a non-flip dsf\0" as *const u8
            as *const libc::c_char)
            .is_null()
    {} else {
        __assert_fail(
...
pub unsafe extern "C" fn dsf_merge_flip(
    ...
    if 0 as libc::c_int <= n1 && (n1 as size_t) < (*dsf).size
        && !(b"Overrun in dsf_merge_flip\0" as *const u8 as *const libc::c_char)
            .is_null()
    {} else {
        __assert_fail(
    ...
    'c_4923: {
        ...
        {} else {
            __assert_fail(
                b"0 <= n1 && n1 < dsf->size && \"Overrun in dsf_merge_flip\"\0"
                    as *const u8 as *const libc::c_char,
                b"/puzzles/dsf.c\0" as *const u8 as *const libc::c_char,
                255 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
    ...
    'c_4861: {
        ...
        {} else {
            __assert_fail(
                b"0 <= n2 && n2 < dsf->size && \"Overrun in dsf_merge_flip\"\0"
                    as *const u8 as *const libc::c_char,
                b"/puzzles/dsf.c\0" as *const u8 as *const libc::c_char,
                256 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
    ...
    'c_4817: {
        if !((*dsf).flip).is_null()
            && !(b"dsf_merge_flip on a non-flip dsf\0" as *const u8
                as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
    ...
    if r1 == r2 {
        if f1 ^ f2 ^ inverse as libc::c_uint == 0 as libc::c_int as libc::c_uint
            && !(b"Inconsistency in dsf_merge_flip\0" as *const u8
                as *const libc::c_char)
                .is_null()
        {} else {
            __assert_fail(
...
#[no_mangle]
pub unsafe extern "C" fn dsf_minimal(
    mut dsf: *mut DSF,
    mut n: libc::c_int,
) -> libc::c_int {
    let mut root: size_t = 0;
    if !((*dsf).min).is_null()
        && !(b"dsf_minimal on a non-min dsf\0" as *const u8 as *const libc::c_char)
            .is_null()
    {} else {
        __assert_fail(
