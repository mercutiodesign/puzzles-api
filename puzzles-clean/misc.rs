...
#[no_mangle]
pub static mut MOVE_UI_UPDATE: [libc::c_char; 1] =
    unsafe { *::core::mem::transmute::<&[u8; 1], &mut [libc::c_char; 1]>(b"\0") };
#[no_mangle]
pub static mut MOVE_NO_EFFECT: [libc::c_char; 1] =
    unsafe { *::core::mem::transmute::<&[u8; 1], &mut [libc::c_char; 1]>(b"\0") };
#[no_mangle]
pub static mut MOVE_UNUSED: [libc::c_char; 1] =
    unsafe { *::core::mem::transmute::<&[u8; 1], &mut [libc::c_char; 1]>(b"\0") };
#[no_mangle]
...
pub unsafe extern "C" fn obfuscate_bitmap(
    ...
    steps[(if decode as libc::c_int != 0 {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    }) as usize]
    ...
    while i < 2 as libc::c_int {
        ...
        while j < steps[i as usize].targetlen {
            ...
            *fresh2 =
                (*fresh2 as libc::c_int ^ digest[fresh1 as usize] as libc::c_int) as libc::c_uchar;
            j += 1;
            j;
        }
        if bits % 8 as libc::c_int != 0 {
            ...
            *fresh3 = (*fresh3 as libc::c_int
                & (0xff as libc::c_int & 0xff00 as libc::c_int >> bits % 8 as libc::c_int))
                as libc::c_uchar;
        }
        i += 1;
        i;
...
pub unsafe extern "C" fn bin2hex(
    ...
    while i < inlen * 2 as libc::c_int {
        let mut v: libc::c_int = *in_0.offset((i / 2 as libc::c_int) as isize) as libc::c_int;
...
pub unsafe extern "C" fn fgetline(mut fp: *mut FILE) -> *mut libc::c_char {
    ...
    while !(fgets(ret.offset(len as isize), size - len, fp)).is_null() {
        len = (len as libc::c_ulong).wrapping_add(strlen(ret.offset(len as isize))) as libc::c_int
            as libc::c_int;
...
unsafe extern "C" fn colour_distance(
    ...
    return __tg_sqrt(
        (*a.offset(0 as libc::c_int as isize) - *b.offset(0 as libc::c_int as isize))
            * (*a.offset(0 as libc::c_int as isize) - *b.offset(0 as libc::c_int as isize))
            + (*a.offset(1 as libc::c_int as isize) - *b.offset(1 as libc::c_int as isize))
                * (*a.offset(1 as libc::c_int as isize) - *b.offset(1 as libc::c_int as isize))
...
pub unsafe extern "C" fn game_mkhighlight_specific(
    ...
    if lowlight >= 0 as libc::c_int {
        db = colour_distance(
            &mut *ret.offset((background * 3 as libc::c_int) as isize) as *mut libc::c_float
        ...
        if db < k {
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                *ret.offset((lowlight * 3 as libc::c_int + i) as isize) = black[i as usize];
                i += 1;
                i;
            }
            if db == 0.0f32 {
                colour_mix(
                    black.as_ptr(),
                    white.as_ptr(),
                    (k as libc::c_double / __tg_sqrt_0(3 as libc::c_int as libc::c_double))
                        as libc::c_float,
    ...
    if highlight >= 0 as libc::c_int {
        ...
        if dw < k {
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                *ret.offset((highlight * 3 as libc::c_int + i) as isize) = white[i as usize];
                i += 1;
                i;
            }
            if dw == 0.0f32 {
...
pub unsafe extern "C" fn shuffle(
    ...
    loop {
        ...
        let mut j: libc::c_int =
            random_upto(rs, (i + 1 as libc::c_int) as libc::c_ulong) as libc::c_int;
        if j != i {
            memswap(
...
pub unsafe extern "C" fn move_cursor(
    ...
    if wrap {
        ...
        *x = if (if *x + dx > 0 as libc::c_int {
            *x + dx
        } else {
            0 as libc::c_int
        }) < maxw - 1 as libc::c_int
        {
            if *x + dx > 0 as libc::c_int {
                *x + dx
            } else {
                0 as libc::c_int
            }
        ...
        *y = if (if *y + dy > 0 as libc::c_int {
            *y + dy
        } else {
            0 as libc::c_int
        }) < maxh - 1 as libc::c_int
        {
            if *y + dy > 0 as libc::c_int {
                *y + dy
            } else {
                0 as libc::c_int
            }
...
pub unsafe extern "C" fn c2diff(
    ...
    if button == CURSOR_UP as libc::c_int
        || button == CURSOR_DOWN as libc::c_int
    ...
    if button == CURSOR_LEFT as libc::c_int
        && cx == w
    ...
    if button == CURSOR_RIGHT as libc::c_int
        && cx == -(1 as libc::c_int)
        && (cy == 0 as libc::c_int || cy == h - 1 as libc::c_int)
    {
        diff = if cy == 0 as libc::c_int {
    ...
    if button == CURSOR_DOWN as libc::c_int
        && cy == -(1 as libc::c_int)
...
pub unsafe extern "C" fn copy_left_justified(
    ...
    if sz > 0 as libc::c_int as size_t {
    } else {
        __assert_fail(
    ...
    if len <= sz.wrapping_sub(1 as libc::c_int as size_t) {
    } else {
        __assert_fail(
    ...
    *buf.offset(sz.wrapping_sub(1 as libc::c_int as size_t) as isize) =
...
pub unsafe extern "C" fn n_times_root_k(
    ...
    while bitpos != 0 {
        ...
        if x.wrapping_mul(x).wrapping_add(r) == (k as libc::c_uint).wrapping_mul(m).wrapping_mul(m)
        {
        } else {
            __assert_fail(
        ...
        if r < (2 as libc::c_int as libc::c_uint)
            .wrapping_mul(x)
        ...
        loop {
            let mut pos: libc::c_uint = (4 as libc::c_int as libc::c_uint)
                .wrapping_mul(r)
                .wrapping_add(
                    (k as libc::c_uint).wrapping_mul(b).wrapping_mul(
        ...
        r = (4 as libc::c_int as libc::c_uint)
            .wrapping_mul(r)
            .wrapping_add(
                b.wrapping_mul(k as libc::c_uint).wrapping_mul(
                    (4 as libc::c_int as libc::c_uint)
                        .wrapping_mul(m)
                        .wrapping_add(1 as libc::c_int as libc::c_uint),
                ),
        ...
        m = (2 as libc::c_int as libc::c_uint)
            .wrapping_mul(m)
            .wrapping_add(b);
        x = (2 as libc::c_int as libc::c_uint)
            .wrapping_mul(x)
            .wrapping_add(a);
    ...
    if sign == 1 as libc::c_int {
        ...
        return -(2147483647 as libc::c_int) - 1 as libc::c_int
            + x.wrapping_neg()
                .wrapping_sub((-(2147483647 as libc::c_int) - 1 as libc::c_int) as libc::c_uint)
                as libc::c_int;
    };
}
